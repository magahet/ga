...
\newcommand{\duedate}{5/26/2018} % problem set deadline
\newcommand{\studentname}{Student Name: }      % name of student (i.e., you)
\newcommand{\classname}{CS 8803 GA -- HW 6.  \hspace{1in}   Name:   }
%%%%%%%%%%%%%%%%%%%%%%%%%%
...
\begin{enumerate}
	\item[1.] [DPV] Problem 8.1 (TSP optimization versus search)
	
	\item[2.] [DPV] Problem 8.3 (Stingy SAT)
	
	\item[3.] [DPV] Problem 8.4 (a),(b),(c) (Clique-3)
	
	\item[4.]  [DPV] Problem 8.10 part (a) (Subgraph isomorphism)  
...
\begin{problem} {[DPV] Problem 8.8 (Exact 4-SAT)}
	\textbf{Solution:}
...
\begin{problem} {[DPV] Problem 8.14 (Clique+IS)}
	\textbf{Solution:}
...
\begin{problem} {[DPV] Problem 8.19 (Kite)}
	\textbf{Solution:}
